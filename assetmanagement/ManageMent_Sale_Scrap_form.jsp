...
<center>
		...
		<div class="form-group">
				...
				<br/><textarea id="txtArea" class="form-control" id="cmnt" name="txtMsg" style="background-color:#FFECEC ; size:50; width:50%; height:40%"  onkeypress="return (event.keyCode!=39)"></textarea>
