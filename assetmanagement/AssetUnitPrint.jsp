...
<%
	...
	System.out.println("Mian Category "+main_cat);
...
<input type="hidden" name="status123" value="">
 ...
 <div id="d1">
	 ...
	 <br>Unit: <font size="2px" color="blue"><%=unit_name %></font> &nbsp;&nbsp;&nbsp;&nbsp;	  DEPARTMENT : <font size="2px" color="red"><%=depName %></font>
	 <%for(int d=0;d<main_cat.size();d++)
	 { 
	 	ArrayList m_name=(ArrayList)main_cat.get(d);%>
		 <table>
		 	<caption><%=m_name.get(1) %></caption>
		 	<tr>
		 		<th>Sl_No</th>
				<th>Asset Name</th>
				<th>ENTRY DATE</th>
			...
			<th>Year</th>
		 	...
		 	<%
		 		ArrayList ar=db.PrintMethod(prog_id, m_name.get(0).toString());
