...
function displ(id)
{
	...
	alert(document.data.search.value);
		...
		String data=request.getParameter("main_cat");
		String depar=request.getParameter("dep_name");
		...
		<div class="">
			<div class="form-group">
				<div class="col-sm-5">
					...
					<center><h3><b>Department</b>:<%=depar %></h3></center>
					<hr>	<tr>
							<th>Department</th>
							<th>Number Of<br/> Assets</th>
						</tr>
						<%	ArrayList Depart=assetManager.selectMainCategory(data);
							System.out.println("Department "+Depart);
							for(int a=0;a<Depart.size();a++)
							{
								ArrayList dep=(ArrayList)Depart.get(a);

									int numb=assetManager.sumAssetInMainCat(data, dep.get(0).toString());
									System.out.println("Data fetch is "+dep.get(1));
									String dep1=""+dep.get(1);
									%>
									<tr>
									<td>
									<a href="ManagementSubCategory.jsp?sub_id=<%=dep.get(0)%>&sub_name=<%=dep.get(1)%>&prog_id=<%=data%>"><%=dep1%></a></td>
									<td><%=numb %></td>
									</tr>
							<% }%>
					</table>
