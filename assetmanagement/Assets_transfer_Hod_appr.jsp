...
<%
	...
	String str="";
	ArrayList res2=assetManager.selectAssetTransfer(1, email, str, "");
...
<div class="container-fluid">
<h5>Assets Transfer Request From Other Department</h5>
<%for(int k=0;k<res2.size();k++)
{
	ArrayList ar4=(ArrayList)res2.get(k);
	str=""+ar4;
	ArrayList res3=assetManager.selectAssetTransfer(5, email, str, "");
	if(!res3.isEmpty())
	{
		flag=true;
	}
		...
		<tr style="border-radius: 50px 20px;">
				<th>Sl No</th>
				<th>Click Below</th>
				<th>Transfer Department From</th>
				<th>Transfer Unit FRom</th>
			</tr>
			<%
			for(int k=0;k<res2.size();k++)
				{
				...
				<%if(!res3.isEmpty()){ %>
				 <tr>
					...
					<td>
						<a href="Assets_Transfer_Appr_Form.jsp?assetId=<%=ar.get(0)%>">Click Here</a>
					</td>
					<td>
						<%=ar.get(1) %>
					</td>
